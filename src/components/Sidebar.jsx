...
import LogoDashBoard from "../data/LogoDashBoard.png";
        ...
        <>
          <div className="flex justify-between items-center">
            <Link
              ...
              className="items-center gap-3 ml-8 mt-4 flex text-xl font-extrabold tracking-tight dark:text-white text-slate-900"
            >
              ...
              <div key={i}>
                ...
                {item.links.map((link) => (
                  <NavLink
                    ...
                    onClick={handleCloseSidebar}
                    style={({ isActive }) => ({
                      backgroundColor: isActive ? "#ffbf00" : "",
                    })}
                    className={({ isActive }) =>
